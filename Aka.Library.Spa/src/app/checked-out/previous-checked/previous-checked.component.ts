...
@Component({
  selector: 'lb-previous-checked',
  templateUrl: './previous-checked.component.html',
  styleUrls: ['./previous-checked.component.scss']
})
export class PreviousCheckedComponent implements OnInit {
